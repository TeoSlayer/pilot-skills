...
```bash
clawhub install pilot-service-agents-packages
```
...
`pilot-protocol`, `service-agents`, `packages`, `registries`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-packages)
