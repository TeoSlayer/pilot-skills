...
pilotctl --json send-message list-agents --data '/data {"category":"packages","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message pypi-package --data '/help' --wait

# 3. Query it
pilotctl --json send-message pypi-package --data '/data {"package":"httpx"}' --wait
```
