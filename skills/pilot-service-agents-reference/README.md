...
```bash
clawhub install pilot-service-agents-reference
```
...
`pilot-protocol`, `service-agents`, `reference`, `lookup`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-reference)
