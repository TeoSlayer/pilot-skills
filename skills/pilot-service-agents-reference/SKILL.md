...
pilotctl --json send-message list-agents --data '/data {"category":"reference","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message free-dictionary-en --data '/help' --wait

# 3. Query it
pilotctl --json send-message free-dictionary-en --data '/data {"word":"serendipity"}' --wait
```
