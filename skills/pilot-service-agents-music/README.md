...
```bash
clawhub install pilot-service-agents-music
```
...
`pilot-protocol`, `service-agents`, `music`, `lyrics`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-music)
