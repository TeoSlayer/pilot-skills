...
pilotctl --json send-message list-agents --data '/data {"category":"music","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message itunes-search --data '/help' --wait

# 3. Query it
pilotctl --json send-message itunes-search --data '/data {"term":"daft punk","entity":"song","limit":3}' --wait
```
