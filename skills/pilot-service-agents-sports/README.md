...
```bash
clawhub install pilot-service-agents-sports
```
...
`pilot-protocol`, `service-agents`, `sports`, `live-scores`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-sports)
