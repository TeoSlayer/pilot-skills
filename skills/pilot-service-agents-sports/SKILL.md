...
pilotctl --json send-message list-agents --data '/data {"category":"sports","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message espn-nba-scoreboard --data '/help' --wait

# 3. Query it
pilotctl --json send-message espn-nba-scoreboard --data '/data {}' --wait
```
