# Service Agents — Government Finance
...
```bash
clawhub install pilot-service-agents-gov-finance
```
...
`pilot-protocol`, `service-agents`, `gov-finance`, `sec`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-gov-finance)
