...
pilotctl --json send-message list-agents --data '/data {"category":"geo","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message gcp-maps-geocoding --data '/help' --wait

# 3. Query it
pilotctl --json send-message gcp-maps-geocoding --data '/data {"address":"1600 Amphitheatre Pkwy Mountain View CA"}' --wait
```
