...
```bash
clawhub install pilot-service-agents-science
```
...
`pilot-protocol`, `service-agents`, `science`, `research`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-science)
