...
pilotctl --json send-message list-agents --data '/data {"category":"transit","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message bart-etd --data '/help' --wait

# 3. Query it
pilotctl --json send-message bart-etd --data '/data {"orig":"POWL"}' --wait
```
