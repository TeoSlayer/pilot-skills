...
```bash
clawhub install pilot-service-agents-transit
```
...
`pilot-protocol`, `service-agents`, `transit`, `public-transport`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-transit)
