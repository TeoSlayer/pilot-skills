# Service Agents — Developer Tools
...
```bash
clawhub install pilot-service-agents-dev
```
...
`pilot-protocol`, `service-agents`, `dev`, `developer-tools`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-dev)
