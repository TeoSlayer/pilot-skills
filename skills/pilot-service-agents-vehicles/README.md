...
```bash
clawhub install pilot-service-agents-vehicles
```
...
`pilot-protocol`, `service-agents`, `vehicles`, `nhtsa`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-vehicles)
