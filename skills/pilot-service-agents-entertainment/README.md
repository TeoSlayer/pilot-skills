...
```bash
clawhub install pilot-service-agents-entertainment
```
...
`pilot-protocol`, `service-agents`, `entertainment`, `games`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-entertainment)
