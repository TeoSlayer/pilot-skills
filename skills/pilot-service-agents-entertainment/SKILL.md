...
pilotctl --json send-message list-agents --data '/data {"category":"entertainment","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message pokeapi-berry --data '/help' --wait

# 3. Query it
pilotctl --json send-message pokeapi-berry --data '/data {"idOrName":"cheri"}' --wait
```
