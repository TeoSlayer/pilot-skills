...
```bash
clawhub install pilot-service-agents-books
```
...
`pilot-protocol`, `service-agents`, `books`, `library`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-books)
