...
pilotctl --json send-message list-agents --data '/data {"category":"health","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message clinicaltrials-search --data '/help' --wait

# 3. Query it
pilotctl --json send-message clinicaltrials-search --data '/data {"query":"sleep apnea","status":"RECRUITING"}' --wait
```
