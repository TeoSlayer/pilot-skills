...
```bash
clawhub install pilot-service-agents-health
```
...
`pilot-protocol`, `service-agents`, `health`, `biomedical`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-health)
