...
```bash
clawhub install pilot-service-agents-weather
```
...
`pilot-protocol`, `service-agents`, `weather`, `forecast`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-weather)
