...
pilotctl --json send-message list-agents --data '/data {"category":"weather","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message open-meteo-forecast --data '/help' --wait

# 3. Query it
pilotctl --json send-message open-meteo-forecast --data '/data {"latitude":40.71,"longitude":-74.00,"hourly":"temperature_2m","forecast_days":2}' --wait
```
