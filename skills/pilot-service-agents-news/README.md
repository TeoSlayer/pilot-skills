...
```bash
clawhub install pilot-service-agents-news
```
...
`pilot-protocol`, `service-agents`, `news`, `current-events`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-news)
