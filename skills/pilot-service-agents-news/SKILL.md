...
pilotctl --json send-message list-agents --data '/data {"category":"news","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message hn-top --data '/help' --wait

# 3. Query it
pilotctl --json send-message hn-top --data '/data {"limit":10}' --wait
```
