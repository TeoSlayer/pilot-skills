...
**Category:** Communication | **License:** AGPL-3.0

## Install

```bash
clawhub install pilot-announce
```
...
`pilot-protocol`, `communication`, `announcements`, `receipts`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-announce)
