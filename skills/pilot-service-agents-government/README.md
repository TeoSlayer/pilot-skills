...
```bash
clawhub install pilot-service-agents-government
```
...
`pilot-protocol`, `service-agents`, `government`, `civic`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-government)
