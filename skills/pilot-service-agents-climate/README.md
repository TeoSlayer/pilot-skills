...
```bash
clawhub install pilot-service-agents-climate
```
...
`pilot-protocol`, `service-agents`, `climate`, `energy`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-climate)
