...
pilotctl --json send-message list-agents --data '/data {"category":"climate","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message carbon-intensity-regional --data '/help' --wait

# 3. Query it
pilotctl --json send-message carbon-intensity-regional --data '/data {"region":"1"}' --wait
```
