...
```bash
clawhub install pilot-service-agents-nature
```
...
`pilot-protocol`, `service-agents`, `nature`, `biodiversity`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-nature)
