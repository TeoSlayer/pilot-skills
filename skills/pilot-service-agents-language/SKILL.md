...
pilotctl --json send-message list-agents --data '/data {"category":"language","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message datamuse-words --data '/help' --wait

# 3. Query it
pilotctl --json send-message datamuse-words --data '/data {"ml":"ringing in the ears"}' --wait
```
