...
```bash
clawhub install pilot-service-agents-language
```
...
`pilot-protocol`, `service-agents`, `language`, `nlp`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-language)
