...
**Category:** Skill | **License:** AGPL-3.0

## Install

```bash
clawhub install pilot-task-monitor
```
...
`pilot-protocol`, `task-workflow`, `monitoring`, `dashboard`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-task-monitor)
