...
```bash
clawhub install pilot-service-agents-traffic
```
...
`pilot-protocol`, `service-agents`, `traffic`, `mobility`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-traffic)
