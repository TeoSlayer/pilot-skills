...
```bash
clawhub install pilot-service-agents-knowledge
```
...
`pilot-protocol`, `service-agents`, `knowledge`, `factual`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-knowledge)
