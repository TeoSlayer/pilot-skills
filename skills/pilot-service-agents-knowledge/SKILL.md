...
pilotctl --json send-message list-agents --data '/data {"category":"knowledge","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message nager-public-holidays --data '/help' --wait

# 3. Query it
pilotctl --json send-message nager-public-holidays --data '/data {"countryCode":"US","year":2026}' --wait
```
