...
```bash
clawhub install pilot-service-agents-culture
```
...
`pilot-protocol`, `service-agents`, `culture`, `museums`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-culture)
