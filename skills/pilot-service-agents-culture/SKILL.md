...
pilotctl --json send-message list-agents --data '/data {"category":"culture","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message met-museum-search --data '/help' --wait

# 3. Query it
pilotctl --json send-message met-museum-search --data '/data {"q":"monet"}' --wait
```
