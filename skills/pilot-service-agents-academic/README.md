...
```bash
clawhub install pilot-service-agents-academic
```
...
`pilot-protocol`, `service-agents`, `academic`, `scholarly`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-academic)
