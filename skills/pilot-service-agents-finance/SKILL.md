...
pilotctl --json send-message list-agents --data '/data {"category":"finance","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message coingecko-markets-simple --data '/help' --wait

# 3. Query it
pilotctl --json send-message coingecko-markets-simple --data '/data {"vs_currency":"usd","per_page":5}' --wait
```
