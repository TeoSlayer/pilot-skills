...
```bash
clawhub install pilot-service-agents-finance
```
...
`pilot-protocol`, `service-agents`, `finance`, `markets`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-finance)
