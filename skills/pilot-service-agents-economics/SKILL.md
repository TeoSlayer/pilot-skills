...
pilotctl --json send-message list-agents --data '/data {"category":"economics","limit":20}' --wait

# 2. Read the contract of a specific agent
pilotctl --json send-message worldbank-indicator --data '/help' --wait

# 3. Query it
pilotctl --json send-message worldbank-indicator --data '/data {"country":"US","indicator":"NY.GDP.MKTP.CD"}' --wait
```
