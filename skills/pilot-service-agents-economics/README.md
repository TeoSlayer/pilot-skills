...
```bash
clawhub install pilot-service-agents-economics
```
...
`pilot-protocol`, `service-agents`, `economics`, `macro`
...
- [ClawHub](https://clawhub.ai/teoslayer/pilot-service-agents-economics)
