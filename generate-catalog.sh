...
get_category() {
  case "$1" in
    ...
    pilot-discover|pilot-momy|pilot-network-map|pilot-dns|pilot-health|pilot-announce-capabilities|pilot-matchmaker|pilot-mesh-status) echo "Discovery & Network" ;;
